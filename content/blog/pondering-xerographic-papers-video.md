...
blockquote {
    ...
    margin: 0;
    padding-inline: 10px;
    border-inline-start: 4px solid #000a;
}
</style>

In June 2025, XerographicPaper made a [video](https://www.youtube.com/watch?v=bCA4U4hqfTk) titled "Why I DON'T Like Toki Pona", which sparked discussion on the flaws of Toki Pona (some solid, some shallow). I watched it as part of my [sin kulupu](https://sin-kulupu.pona.la/) reporting.
...
Similarly, I don't try to sell Toki Pona to people who come to [the course I wrote, Wasona](https://wasona.com/). If someone has decided they want to learn it, here you go, feel free to start. If not, have fun doing other things. It's fine.
...
> So, in order to let you judge for yourself, I translated the entirety of tu kuntu into  English. [in the description] I LIED A LITTLE BIT though [its not complete](https://xpaper.neocities.org/tukuntuINCOMPLETE1.pdf)

[tu kuntu](https://lipu.pona.la/2021/02/tu-kuntu/) is probably one of my favourite niche literary pieces I've ever read, given how many factors needed to collide for someone to enjoy or even comprehend the jokes.
...
Anyway, on a related note, I once did a relex of Toki Pona where each relexed word is voted on by the community. [You can find it here](https://sona.pona.la/wiki/User:.vivivivivi/susu_sen). The overall impression I can give was that it was fun, but the end product looks more oddly-designed than Toki Pona. The words are too short and too many start with a vowel.
